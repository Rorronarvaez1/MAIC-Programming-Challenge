...
single-page application es perfecta para esto. 
○ Implementa un componente para subir archivos (la funcionalidad de 
drag-and-drop es un plus) que acepte formatos .xlsx y .csv. 
...
seleccionados. Usa una librería de gráficos como Recharts, Chart.js, o D3. 
